...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2 = QtWidgets.QFormLayout(self.file_tab)
        self.formLayout_2.setContentsMargins(0, 0, 0, 0)
        self.formLayout_2.setSpacing(0)
        self.formLayout_2.setObjectName("formLayout_2")
        self.project_tree = QtWidgets.QTreeWidget(self.file_tab)
        self.project_tree.setObjectName("project_tree")
        self.project_tree.headerItem().setText(0, "1")
        self.project_tree.header().setVisible(False)
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.project_tree)
        icon1 = QtGui.QIcon()
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.tabWidget_2)
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setTabsClosable(True)
        self.tabWidget.setObjectName("tabWidget")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.tabWidget)
        self.formLayout_3.setLayout(0, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.formLayout)
